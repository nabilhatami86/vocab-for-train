                ...
                {track.track === 'grammar' && (
                  <>
                    <Link
                      ...
                      className="group border border-violet-400/50 bg-violet-50/40 dark:bg-violet-950/20 hover:bg-violet-50 dark:hover:bg-violet-950/30 rounded-xl p-3 transition-colors sm:col-span-2"
                    >
                      <div className="flex items-center gap-3">
