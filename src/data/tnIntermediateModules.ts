...
const grammarLessons: ModuleLesson[] = [
  ...
  // ── Day 19 · Adjective Clause (Relative Clause) ───────────────────────────────
  {
    id: "int-grammar-13",
    track: "grammar",
    day: 19,
    ...
    materialSections: [
      ...
      },
      {
        ...
        points: [
          ...
          "│  Jenis  │  Pola              │  Conj               │",
          "│─────────┼────────────────────┼─────────────────────│",
          "│  RPS    │  N + C + V         │ who / which / that  │",
          "│  RPO    │  N + C + S + V     │ whom / which / that │",
          "└─────────────────────────────────────────────────────┘",
          "",
          "Tips: Jika noun yang dijelaskan = orang → who/whom",
          "      Jika noun yang dijelaskan = benda → which",
          "      'that' bisa untuk keduanya (orang & benda)",
        ],
      },
    ],
    exercises: [
