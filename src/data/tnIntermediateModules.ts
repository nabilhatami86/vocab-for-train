  ...
  // ── Day 11: Human Body Parts and Organs ─────────────────────────────────────
  {
    ...
    exercises: [
      // ── MULTIPLE CHOICE ────────────────────────────────────────────────────────
      {
        ...
        options: [
          "A. To explain how humans think.",
          "B. To list the organs located on the head.",
          "C. To compare human heads with animal heads.",
        ],
        correctAnswer: "A",
        reason:
          "A — Paragraf pertama memperkenalkan manusia sebagai makhluk luar biasa dengan kemampuan berpikir dan tubuh yang mengesankan ('capable of detailed thought', 'remarkable bodies'). Tujuannya adalah menjelaskan keunggulan manusia secara umum.",
      },
      {
        id: "int-r11-mc2",
        type: "multiple-choice",
        question: "According to the text, what is the function of the tongue?",
        options: [
          "A. Helping humans maintain balance.",
          "B. Helping humans chew and speak.",
          "C. Protecting the throat from bacteria.",
        ],
        correctAnswer: "B",
        reason:
          "B — Dari paragraf 4: 'the tongue, or a red-colored, boneless organ used to chew food and speak.' Fungsi lidah adalah mengunyah makanan dan berbicara.",
      },
      {
        id: "int-r11-mc3",
        type: "multiple-choice",
        question: "Why does the author describe the eyebrows as \"horizontal strips of hair\"?",
        options: [
          "A. To give a visual explanation of their appearance.",
          "B. To suggest that eyebrows control facial expressions.",
          "C. To compare them to other types of hair on the body.",
        ],
        correctAnswer: "A",
        reason:
          "A — Penulis menggunakan frasa 'horizontal strips of hair' sebagai definisi deskriptif untuk menjelaskan bentuk alis secara visual. Ini adalah cara penulis menggambarkan seperti apa alis itu.",
      },
      {
        id: "int-r11-mc4",
        type: "multiple-choice",
        question: "Which idea can be inferred about the author's attitude toward the human body?",
        options: [
          "A. The human body is poorly designed.",
          "B. The human body is impressive and capable.",
          "C. The human body needs improvement.",
        ],
        correctAnswer: "B",
        reason:
          "B — Penulis menggunakan kata-kata positif seperti 'remarkable bodies', 'overcome predators, disease', dan 'accomplished'. Sikap penulis jelas mengagumi tubuh manusia.",
      },
      {
        id: "int-r11-mc5",
        type: "multiple-choice",
        question: "What is the organizational pattern of the text?",
        options: [
          "A. Comparison and contrast of human body.",
          "B. Chronological order of human body.",
          "C. Description of human body.",
        ],
        correctAnswer: "C",
        reason:
          "C — Teks mendeskripsikan bagian-bagian tubuh manusia satu per satu beserta lokasi dan fungsinya. Tidak ada perbandingan antar-objek (A) maupun urutan waktu (B).",
      },
      // ── TABLE COMPLETION ───────────────────────────────────────────────────────
      {
        id: "int-r11-tc1",
        type: "short-answer",
        section: "final",
        question: "[Table Row 1] Body Part: ___  |  Location: At the top of the body  |  Main Function: Contains the brain",
        sampleAnswer: "Head",
        reason: "Paragraf 3: 'The head, or the spherical body part that contains the brain and rests at the top of the human body.'",
      },
      {
        id: "int-r11-tc2",
        type: "short-answer",
        section: "final",
        question: "[Table Row 2] Body Part: Eyebrows  |  Location: ___  |  Main Function: Serve as horizontal strips of hair",
        sampleAnswer: "Above the eye(s)",
        reason: "Paragraf 3: 'eyebrows, or horizontal strips of hair that can be found above the eye.'",
      },
      {
        id: "int-r11-tc3",
        type: "short-answer",
        section: "final",
        question: "[Table Row 3] Body Part: Nose  |  Location: Between the ___ and ___  |  Main Function: Helps with breathing and bacteria-elimination",
        sampleAnswer: "eyes / mouth",
        reason: "Dari teks: 'The eyes make way for the nose... Below that is the mouth.' Hidung berada di antara mata (di atas) dan mulut (di bawah).",
      },
      {
        id: "int-r11-tc4",
        type: "short-answer",
        section: "final",
        question: "[Table Row 4] Body Part: Mouth  |  Location: Below the nose  |  Main Function: ___ and speak",
        sampleAnswer: "Chew food",
        reason: "Paragraf 4: 'the tongue, or a red-colored, boneless organ used to chew food and speak.' Fungsi mulut: chew food and speak.",
      },
      {
        id: "int-r11-tc5",
        type: "short-answer",
        section: "final",
        question: "[Table Row 5] Body Part: ___  |  Location: Between the head and chest  |  Main Function: Links head to the chest",
        sampleAnswer: "Neck",
        reason: "Paragraf 5: 'The neck is the long body part that connects the head to the chest.'",
      },
      {
        id: "int-r11-tc6",
        type: "short-answer",
        section: "final",
        question: "[Table Row 6] Body Part: ___  |  Location: Lower part of the ___  |  Main Function: Absorbs shock during movement",
        sampleAnswer: "Calf / leg",
        reason: "Paragraf 6: 'a calf (thinner, more flexible body part that absorbs the shock associated with movement; the lower part of the leg).'",
      },
      {
        id: "int-r11-tc7",
        type: "short-answer",
        section: "final",
        question: "[Table Row 7] Body Part: Fingers  |  Location: At the end of the hands  |  Main Function: Used to ___ objects",
        sampleAnswer: "grip",
        reason: "Paragraf 7: 'five fingers, or small appendages used to grip objects.'",
      },
      {
        id: "int-r11-tc8",
        type: "short-answer",
        section: "final",
        question: "[Table Row 8] Body Part: Back  |  Location: Behind the ___  |  Main Function: Protects ___ and assists body movements",
        sampleAnswer: "stomach / the lungs and other internal organs",
        reason: "Paragraf 8: 'found on the opposite side of the stomach… muscles that're intended to protect the lungs and other internal organs, in addition to helping humans perform certain motions.'",
      },
    ],
  },
  ...
  // ── Day 12: Food For a Community ────────────────────────────────────────────
  {
    ...
    exercises: [
      // ── MULTIPLE CHOICE ────────────────────────────────────────────────────────
      {
        ...
        options: [
          "A. Daily life in Mexico City.",
          "B. Farming in Milpa Alta.",
          "C. A tradition in Mexico.",
        ],
        correctAnswer: "C",
        reason:
          "C — Artikel membahas La Rejunta, sebuah tradisi pesta komunitas tahunan di Milpa Alta, Mexico. Bukan tentang kehidupan sehari-hari di Mexico City (A) atau pertanian (B).",
      },
      {
        id: "int-r12-mc2",
        type: "multiple-choice",
        question: "What's unusual thing about La Rejunta?",
        options: [
          "A. An enormous amount of food is made.",
          "B. The event lasts for many days.",
          "C. The ingredients of food are very unusual.",
        ],
        correctAnswer: "A",
        reason:
          "A — Paragraf 1 menyebutkan sekitar 60.000 tamales dan 15.000 liter hot chocolate dibuat — ini adalah jumlah yang luar biasa besar. Teks tidak menyebut berlangsung berhari-hari (B) atau bahan yang tidak biasa (C).",
      },
      {
        id: "int-r12-mc3",
        type: "multiple-choice",
        question: "What is the responsibility of the Majordomos?",
        options: [
          "A. To cook the food for La Rejunta",
          "B. To grow the ingredients for La Rejunta",
          "C. To organise the cuisine for La Rejunta",
        ],
        correctAnswer: "C",
        reason:
          "C — Paragraf 2: 'they're responsible for organising the meal.' Majordomo bertanggung jawab mengorganisir/mengatur pelaksanaan La Rejunta.",
      },
      {
        id: "int-r12-mc4",
        type: "multiple-choice",
        ...
        options: [
          ...
          "B. People waiting for a long time to be Majordomos.",
          "C. Virginia Meza Torres has been a majordomo for 14 years.",
        ],
        correctAnswer: "B",
        reason:
          "B — Paragraf 2: ada waiting list dan 'the next available year is 2046'. Virginia & Fermín menunggu 14 tahun (bukan menjadi majordomo selama 14 tahun — C salah). A juga salah karena daftar tunggu justru menunjukkan banyak peminat.",
      },
      {
        id: "int-r12-mc5",
        type: "multiple-choice",
        ...
        correctAnswer: "A",
        reason:
          "A — Paragraf 3: 'Local farmers grow most of the corn, meat and vegetables that are needed as ingredients.' Bahan-bahan berasal dari petani lokal. B salah (persiapan setahun, bukan seminggu). C salah (ada ratusan relawan yang membantu).",
      },
      // ── TRUE / FALSE / NOT GIVEN ───────────────────────────────────────────────
      {
        id: "int-r12-tfng1",
        type: "true-false-not-given",
        question: "La Rejunta is celebrated every Christmas in Milpa Alta.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "True",
        reason:
          "TRUE — Paragraf 1: 'It takes place every Christmas and is called La Rejunta.'",
      },
      {
        id: "int-r12-tfng2",
        type: "true-false-not-given",
        question: "Only local families are allowed to attend the feast.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "Not Given",
        reason:
          "NOT GIVEN — Teks tidak menyebutkan siapa yang boleh atau tidak boleh hadir di La Rejunta. Teks hanya menyebut 'as many as 20,000 people take part' tanpa batasan siapa.",
      },
      {
        id: "int-r12-tfng3",
        type: "true-false-not-given",
        question: "Milpa Alta means \"large village by the mountains.\"",
        options: ["True", "False", "Not Given"],
        correctAnswer: "False",
        reason:
          "FALSE — Paragraf 1: 'the name Milpa Alta means \"High cornfield\".' Bukan 'large village by the mountains'.",
      },
      {
        id: "int-r12-tfng4",
        type: "true-false-not-given",
        question: "More than 50,000 people usually walk to El Señor de Chalma every year.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "Not Given",
        reason:
          "NOT GIVEN — Teks menyebut 'as many as 20,000 people take part' (dalam La Rejunta), bukan jumlah orang yang berjalan ke El Señor de Chalma. Jumlah peziarah tidak disebutkan dalam teks.",
      },
      {
        id: "int-r12-tfng5",
        type: "true-false-not-given",
        question: "Majordomos are responsible for organising the annual feast.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "True",
        reason:
          "TRUE — Paragraf 2: 'they're responsible for organising the meal.'",
      },
      {
        id: "int-r12-tfng6",
        type: "true-false-not-given",
        question: "Virginia Meza Torres and Fermín Lara Jiménez became majordomos the same year they signed up.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "False",
        reason:
          "FALSE — Paragraf 2: 'who put their names on the list 14 years ago.' Mereka mendaftar 14 tahun lalu, bukan menjadi majordomo di tahun yang sama.",
      },
      {
        id: "int-r12-tfng7",
        type: "true-false-not-given",
        question: "The wood used for cooking must be collected a year before the feast.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "True",
        reason:
          "TRUE — Paragraf 3: 'One year before the meal, men go to the forest and collect wood.'",
      },
      {
        id: "int-r12-tfng8",
        type: "true-false-not-given",
        question: "Ready-made ingredients are forbidden during the preparation of La Rejunta.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "True",
        reason:
          "TRUE — Paragraf 3: 'No instant or ready-made foods are allowed.'",
      },
      {
        id: "int-r12-tfng9",
        type: "true-false-not-given",
        question: "Fermín cooks all the tamales by himself.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "False",
        reason:
          "FALSE — Paragraf 3: 'Fermin is in charge of the numbers — making sure there are enough tamales for everyone.' Ia mengatur jumlah, bukan memasak sendiri. Selain itu, 'hundreds of volunteers arrive to help with the preparation and the cooking.'",
      },
      {
        id: "int-r12-tfng10",
        type: "true-false-not-given",
        question: "Josefina García Jiménez believes that the time spent together after eating is just as important as the food.",
        options: ["True", "False", "Not Given"],
        correctAnswer: "True",
        reason:
          "TRUE — Paragraf 4: 'The time that everybody stays at the table after the meal has finished is just as important as the food.'",
      },
    ],
  },
  ...
  // ── Day 13: Choosing a Musical Instrument ────────────────────────────────
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        correctAnswer: "A",
        reason:
          "A — Teks: 'If you're small and don't like lifting heavy objects, you won't want to carry around a double bass' — ukuran dan berat instrumen perlu dipertimbangkan.",
      },
      {
        id: "int-r13-mc7",
        type: "multiple-choice",
