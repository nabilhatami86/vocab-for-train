  ...
  // ── Day 2: Introduction to Tenses + Simple Present ───────────────────────────
  {
    ...
    materialSections: [
      ...
      },
      {
        ...
        points: [
          "Digunakan untuk: kebiasaan, kebenaran umum (general truth), judul berita, hal ilmiah.",
          "Time signal: every day, every week, often, usually, sometimes, always, etc.",
          "─────────────────────────────",
          "VERBAL ACTIVE:",
          "  (+) S + V1 s/es",
          "  (-) S + do/does + not + V1",
      ...
      {
        title: "Examples — Simple Present",
        points: [
          "Verbal Active (+): She reads a book every day.",
          "Verbal Active (-): She does not read a book every day.",
          "Verbal Active (?): Does she read a book every day?",
          "Verbal Passive (+): The book is read by her every day.",
          "Non-Verbal (+): She is a student.",
          "Non-Verbal (-): She is not a student.",
          "Non-Verbal (?): Is she a student?",
        ],
      },
    ],
    exercises: [
